    ...
    <>
      <nav className="flex justify-center xl:gap-[187px] 2xl:gap-[187px] gap-[70%] relative mb-[10px] p-2">
        ...
        <section className="xl:flex xl:gap-4 xl:mt-4 2xl:flex 2xl:gap-4 2xl:mt-4 hidden">
          <Link href="/">
            <h1 className={`font-light text-[14px] ${isActive("/") ? "text-[#FCC400]" : "text-[#696969]"}`}>Home</h1>
          </Link>
          <Link href="/Aboutus">
            <h1 className={`font-normal text-[14px] ${isActive("/Aboutus") ? "text-[#FCC400]" : "text-[#696969]"}`}>About us</h1>
          </Link>

          <div className="flex relative">
            <h1 onClick={toggleDropdown} className="cursor-pointer font-light text-[14px]">Himachal GK</h1>
            ...
            {isMenuVisible && (
              ...
              >
                <nav className="flex flex-col gap-4 text-lg font-semibold text-gray-800">
                  ...
                  <Link href="/TestSeries"><h1 className={`border-b pb-2 ${isActive("/TestSeries") ? "text-[#FCC400]" : "text-[#696969]"}`}>Test Series</h1></Link>
                  <Link href="/HpQuiz"><h1 className={`border-b pb-2 ${isActive("/HpQuiz") ? "text-[#FCC400]" : "text-[#696969]"}`}>HP Quiz</h1></Link>
