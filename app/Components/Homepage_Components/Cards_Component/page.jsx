  ...
  return (
    <>
      <div className="flex flex-wrap  justify-center gap-[30px] bg-[#FFFFFF] w-[1207.563232421875px] rounded-3xl pt-10 relative bottom-20 p-5">
        ...
        <section className="bg-[#5AB943] w-[341.61566162109375px] h-[172.69000244140625px] rounded-[10px] text-center flex flex-col items-center justify-center">
          <Image
            src={Learn_Icon}
            width={44.39681625366211}
            height={42.06013870239258}
        ...
        <section className="bg-[#FCC400] w-[341.61566162109375px] h-[172.69000244140625px] rounded-[10px] text-center flex flex-col items-center justify-center">
          <Image
            src={Education_Icon}
            width={44.39681625366211}
            height={42.06013870239258}
