      ...
      <div className="flex flex-wrap gap-3 justify-center p-3">
        <section className="flex flex-col md:flex-row items-center">
          ...
          <Image
            ...
            height={531.4886474609375}
            alt="no image"
            className="rounded-[20px] relative top-8 md:top-28 md:right-24 w-full md:w-auto"
          />
        </section>

        <section className="relative top-8 md:top-16 text-center md:text-left">
          ...
          <p className="font-normal text-[14px] md:text-[16px] w-full md:w-[475.13043212890625px] text-[#696969] leading-[24px] md:leading-[30.4px]">
