...
const Slide2 = () => {
  return (
    <>
      <div className="h-full md:h-[619.11px] xl:h-[619.11px] 2xl:h-[619.11px] w-full flex flex-col-reverse md:flex-row justify-center items-center bg-[#002975] pt-10 pb-14 p-3">
