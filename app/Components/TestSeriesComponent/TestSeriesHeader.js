...
const TestSeriesHeader = () => {
    return(
        ...
        <div style={{backgroundImage : `url("${Banner.src}")`}} className="bg-cover bg-no-repeat text-center pt-[100px] pb-[100px]">
                    <h1 className="text-[50px] text-[#FFFFFF] font-semibold uppercase">test series of Himachal</h1> 
                    ...
                    <div className="flex justify-center gap-2">
                        ...
                        <h1 className="text-[20px] text-[#FDC107] font-normal capitalize">test series of Himachal</h1>
                    </div>
                </div>
        </>
    )
