...
const HimachalHistoryHeader = () => {
    return(
        <>
        <div style={{backgroundImage : `url("${Banner.src}")`}} className="bg-cover bg-no-repeat text-center pt-[100px] pb-[100px]">
                    <h1 className="text-[50px] text-[#FFFFFF] font-semibold uppercase">History of Himachal</h1> 
                    ...
                    <div className="flex justify-center gap-2">
                        ...
                        <h1 className="text-[20px] text-[#FDC107] font-normal capitalize">History of Himachal</h1>
                    </div>
                </div>
        </>
    )
...
export default HimachalHistoryHeader;